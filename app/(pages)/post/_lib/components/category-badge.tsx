...
export default function CategoryBadge({
  ...
  return (
    <Badge
      variant="secondary"
      className={`cursor-pointer capitalize font-normal px-2 py-[0.375em] text-sm hover:bg-primary/95 hover:text-secondary hover:transition-all hover:duration-200  ${
        isSelected &&
